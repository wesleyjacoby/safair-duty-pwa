...
/* ---------------- Release identifiers ---------------- */
const SW_REG_VERSION = "3.12"; // used for ./sw.js?v=...  (bump on deploy)
const EXPECTED_CACHE = "safair-duty-v3.12"; // must equal CACHE in sw.js
const APP_VERSION = "v3.12"; // footer fallback if SW not ready
